	...
	<ul class="nav navbar-top-links navbar-right">
		...
		<li class="dropdown"><a data-toggle="dropdown" href="#"> Task <i class="fa fa-caret-down"></i>
			...
			<ul class="dropdown-menu dropdown-user">
				<li><a href="Assignments.jsp">
						Assignment</a></li>
				<li class="divider"></li>
				<li><a href="Quizes.jsp">
						Quiz</a></li>
			</ul></li>
		<li class="dropdown"><a data-toggle="dropdown" href="#"> Study Material <i class="fa fa-caret-down"></i>
		</a>
			<ul class="dropdown-menu dropdown-user">
				<li><a href="Lecture_Links.jsp">
						Video Lectures</a></li>
				<li class="divider"></li>
				<li><a href="UploadDocument.jsp">
		...
		<li class="dropdown"><a data-toggle="dropdown" href="#"> Profile <i class="fa fa-caret-down"></i>
			...
			<ul class="dropdown-menu dropdown-user">
				<li><a href="myprofile.jsp"><i class="fa fa-user fa-fw"></i>
						My Profile</a></li>
