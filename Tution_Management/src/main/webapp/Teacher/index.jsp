...
%>
 --%>	
	...
	<div >
	<form action="">
	<textarea rows="10" style="border:2px solid black; width : 40%; margin-left:30%; margin-top:4%;text-align:center;margin-bottom:20px;" placeholder="Do announcements here..">
